...
<% 
	...
	Article art = dao.getUniqueByKeyValue(Article.class, "where name='company' and _site =?", request.getServerName());
					...
					<form name="form1" class="add-form" onsubmit="return false;">
						...
						<table style="width:100%" >
							<tr class="form-group" style="display:none">
								...
								<td><input name="name" id="name" value="company" class="form-input" /></td>
							</tr>
							<tr class="form-group">
